...
<a href="<?= base_url('admin/lokasi_presensi/create') ?>" class="btn btn-primary"><i class="lni lni-circle-plus"></i> Tambah Data</a>
        ...
        <?php $no=1; foreach($lokasi_presensi as $lok): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('admin/lokasi_presensi/edit/'.$lok['id']) ?>" class="badge bg-primary">Ubah</a>
